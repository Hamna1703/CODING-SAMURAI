...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        // Create a placeholder for quiz background
        JLabel image = new JLabel();
        image.setBounds(0, 0, 1440, 392);
        image.setBackground(new Color(240, 248, 255));
        image.setOpaque(true);
        image.setBorder(BorderFactory.createLineBorder(Color.LIGHT_GRAY, 1));
        image.setHorizontalAlignment(SwingConstants.CENTER);
        image.setText("JAVA QUIZ APPLICATION");
        image.setFont(new Font("Arial", Font.BOLD, 36));
        image.setForeground(new Color(30, 144, 254));
        add(image);
        ...
        setTitle("Quiz Application - " + name);
        start(count);
